...
---
### Update log
- Updated on 2024-07-20: Correct the computation steps in the "Backpropagation on a Neural Network" section.
...
& = \left(\frac{\partial w_6}{\partial w_5}\right)\frac{\partial w_5}{\partial w_1} + \cos(w_1) \\
...
\dot{\hat{y}} & = \frac{\partial L}{\partial \hat{y}} = 2(\hat{y}-y) \\
\dot{z_3} & = \frac{\partial L}{\partial z_{3}} = \dot{\hat{y}}\sigma'(z_{3}) \\
\dot{\mathbf{W}^3} & = \dot{z_3}\mathbf{z}_2^\top \quad \text{($1\times 2$ matrix)} \\
\dot{b^3} & = \dot{z_3} \\
...
\dot{\mathbf{x}} & = {\mathbf{W}^1}^\top\dot{\mathbf{z}_1}
\end{aligned}
$$
## Summary
